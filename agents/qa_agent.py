...
QA_MODEL = "anthropic/claude-3.5-haiku"
...
def review_html(html_content, spec):
    ...
    review = call_llm_json(QA_MODEL, system_prompt, user_prompt)
...
def review_marketing_copy(copy):
    ...
    LinkedIn: {copy['social_posts']['linkedin'][:200]}
    Instagram: {copy['social_posts']['instagram']}
    ...
    4. Are all 3 social posts engaging and specific?
